...
'''
        ...
        parser.add_argument("-p", "--data_path", required=False, default='0',
...
def get_command_line_arguments():
    def parse_args():
        ...
        #
        #
        # parser.add_argument("-p", "--data_path", required=False, default="data_test/1.mp4",
        #                     help="path to a video file, or images folder, or webcam. \n"
        #                     "For video and folder, the path should be "
        #                     "absolute or relative to this project's root. "
        #                     "For webcam, either input an index or device name. ")
        ...
        parser.add_argument("-p", "--data_path", required=False, default="123.mp4",
                            help="path to a video file, or images folder, or webcam. \n"
                            "For video and folder, the path should be "
                            "absolute or relative to this project's root. "
                            "For webcam, either input an index or device name. ")
